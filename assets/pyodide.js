...
var loadPyodide = (() => {
  ...
  var s = (e, t) => I(e, "name", { value: t, configurable: !0 }),
    p = ((e) => (typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (t, i) => (typeof require < "u" ? require : t)[i] }) : e))(function (e) {
  ...
  var se = (e, t) => {
    ...
    $ = (e, t, i, r) => {
      if ((t && typeof t == "object") || typeof t == "function") for (let a of ie(t)) !ae.call(e, a) && a !== i && I(e, a, { get: () => t[a], enumerable: !(r = re(t, a)) || r.enumerable });
      return e;
    };
  var b = (e, t, i) => ((i = e != null ? ne(oe(e)) : {}), $(t || !e || !e.__esModule ? I(i, "default", { value: e, enumerable: !0 }) : i, e)),
    ce = (e) => $(I({}, "__esModule", { value: !0 }), e);
  var Ie = {};
  se(Ie, { loadPyodide: () => B, version: () => x });
  function le(e) {
...
`,
  ...
  var y = typeof process == "object" && typeof process.versions == "object" && typeof process.versions.node == "string" && !process.browser,
    ...
    pe = typeof Deno < "u",
    z = !y && !pe,
    V = z && typeof window == "object" && typeof document == "object" && typeof document.createElement == "function" && "sessionStorage" in window && typeof importScripts != "function",
  ...
  y || (W = "/");
  function be(e, t) {
    return e.startsWith("file://") && (e = e.slice(7)), e.includes("://") ? { response: fetch(e) } : { binary: M.readFile(e).then((i) => new Uint8Array(i.buffer, i.byteOffset, i.byteLength)) };
  }
  ...
  s(G, "loadBinaryFile");
  var O;
  if (V) O = s(async (e) => await import(/* webpackIgnore */ e), "loadScript");
  else if (q)
    O = s(async (e) => {
      try {
      ...
      a = {
        ...
        getLocalSet: (n) => {
          ...
          for (; d.length; ) {
            let u = d.pop(),
              m = t.stat(u);
            t.isDir(m.mode) && d.push.apply(d, t.readdir(u).filter(c).map(l(u))), (o[u] = { timestamp: m.mtime, mode: m.mode });
          }
        ...
        getRemoteSet: async (n) => {
          ...
          for (let [l, d] of c)
            l !== "." && (o[r.join2(n.mountpoint, l)] = { timestamp: d.kind === "file" ? (await d.getFile()).lastModifiedDate : new Date(), mode: d.kind === "file" ? a.FILE_MODE : a.DIR_MODE });
        ...
        loadLocalEntry: (n) => {
          ...
          if (t.isFile(l.mode)) return (c.contents = i.getFileDataAsTypedArray(c)), { timestamp: l.mtime, mode: l.mode, contents: c.contents };
        ...
        loadRemoteEntry: async (n) => {
          if (n.kind === "file") {
            ...
            return { contents: new Uint8Array(await o.arrayBuffer()), mode: a.FILE_MODE, timestamp: o.lastModifiedDate };
          } else {
        ...
        storeRemoteEntry: async (n, o, c) => {
          let l = n.get(r.dirname(o)),
            d = t.isFile(c.mode) ? await l.getFileHandle(r.basename(o), { create: !0 }) : await l.getDirectoryHandle(r.basename(o), { create: !0 });
          if (d.kind === "file") {
  ...
  function Ne(e) {
    return (t) => {
      for (let i of e) t.FS.mkdirTree(i), t.FS.mount(t.FS.filesystems.NODEFS, { root: i }, i);
    };
  }
  s(Ne, "mountLocalDirectories");
  function _e(e) {
    let t = G(e);
    return (i) => {
      ...
      i.FS.mkdirTree("/lib"),
        i.FS.mkdirTree(`/lib/python${r}.${a}/site-packages`),
  ...
  s(Fe, "getFileSystemInitializationFuncs");
  function Re(e) {
    if (typeof WasmOffsetConverter < "u") return;
    let { binary: t, response: i } = P(e + "pyodide.asm.wasm");
    return function (r, a) {
      return (
        (async function () {
          try {
  ...
  async function B(e = {}) {
    ...
    let i = {
        ...
        checkAPIVersion: !0,
        BUILD_ID: "f88dc4abb40ec8e780c94a5f70bcef45ec9eb3c1aee1c99da527febfef1c6f3f",
      },
      r = Object.assign(i, e);
    ...
    if (e._loadSnapshot) {
      ...
      ArrayBuffer.isView(f) ? (o = f) : (o = new Uint8Array(f)), (a.noInitialRun = !0), (a.INITIAL_MEMORY = o.length);
    }
    let c = await _createPyodideModule(a);
    if (a.exited) throw a.exited.toThrow;
    if ((e.pyproxyToStringRepr && n.setPyProxyToStringMethod(!0), n.version !== x && r.checkAPIVersion))
      throw new Error(`Pyodide version does not match: '${x}' <==> '${n.version}'. If you updated the Pyodide version, make sure you also updated the 'indexURL' parameter passed to loadPyodide.`);
    c.locateFile = (f) => {
    ...
    return (
      ...
      d.version.includes("dev") || n.setCdnUrl(`https://cdn.jsdelivr.net/pyodide/v${d.version}/full/`),
