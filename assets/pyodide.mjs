...
var s = (e, t) => Q(e, "name", { value: t, configurable: !0 }),
  I = ((e) => (typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (t, o) => (typeof require < "u" ? require : t)[o] }) : e))(function (e) {
...
s(q, "loadBinaryFile");
var F;
if ($) F = s(async (e) => await import(/* @vite-ignore */ e), "loadScript");
else if (j)
  F = s(async (e) => {
    try {
      globalThis.importScripts(e);
    } catch (t) {
      if (t instanceof TypeError) await import(/* @vite-ignore */ e);
      else throw t;
    }
  }, "loadScript");
else if (g) F = le;
...
async function le(e) {
  e.startsWith("file://") && (e = e.slice(7)), e.includes("://") ? V.runInThisContext(await (await fetch(e)).text()) : await import(/* @vite-ignore */ z.pathToFileURL(e).href);
}
s(le, "nodeLoadScript");
async function J(e) {
  if (g) {
  ...
  let t = e.FS,
    ...
    a = {
      ...
      getRemoteSet: async (n) => {
        ...
        for (let [l, d] of c)
          l !== "." && (i[r.join2(n.mountpoint, l)] = { timestamp: d.kind === "file" ? (await d.getFile()).lastModifiedDate : new Date(), mode: d.kind === "file" ? a.FILE_MODE : a.DIR_MODE });
      ...
      storeRemoteEntry: async (n, i, c) => {
        let l = n.get(r.dirname(i)),
          d = t.isFile(c.mode) ? await l.getFileHandle(r.basename(i), { create: !0 }) : await l.getDirectoryHandle(r.basename(i), { create: !0 });
        if (d.kind === "file") {
...
async function $e(e = {}) {
  ...
  if ((e.pyproxyToStringRepr && n.setPyProxyToStringMethod(!0), n.version !== M && r.checkAPIVersion))
...
s($e, "loadPyodide");
export { $e as loadPyodide, M as version };
