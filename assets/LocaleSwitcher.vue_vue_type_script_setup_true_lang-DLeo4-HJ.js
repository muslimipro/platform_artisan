...
`)},ft={root:"p-iconfield"},mt=Y.extend({name:"iconfield",theme:ht,classes:ft}),gt={name:"BaseIconField",extends:ie,style:mt,provide:function(){return{$pcIconField:this,$parentInstance:this}}},ke={name:"IconField",extends:gt,inheritAttrs:!1};function vt(t,e,n,o,s,i){return p(),m("div",u({class:t.cx("root")},t.ptmi("root")),[I(t.$slots,"default")],16)}ke.render=vt;var bt={root:"p-inputicon"},yt=Y.extend({name:"inputicon",classes:bt}),It={name:"BaseInputIcon",extends:ie,style:yt,props:{class:null},provide:function(){return{$pcInputIcon:this,$parentInstance:this}}},Le={name:"InputIcon",extends:It,inheritAttrs:!1,computed:{containerClass:function(){return[this.cx("root"),this.class]}}};function Ot(t,e,n,o,s,i){return p(),m("span",u({class:i.containerClass},t.ptmi("root")),[I(t.$slots,"default")],16)}Le.render=Ot;var wt=function(e){var n=e.dt;return`
